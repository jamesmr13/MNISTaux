function mnist_2categories_quadratic_NLLS_Adam()
close all
fsz = 20;
...
batch_size=256;
%
[w,f,gnorm] = Adam(Xtrain,label,w,batch_size,no_epochs,tol);
figure;
plot(f,'Linewidth',2);
...
function [w,fvals,gnorm] = Adam(X,y,w,batch_size,no_epochs,tol)
